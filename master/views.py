...
def addproperties(request,id):
    obj=SubCategory.objects.get(id=id)
    allsubobj=SubCategory.objects.all()
    context={'obj':obj , 'allsubobj':allsubobj}
    return render(request,'master/addproperties.html',context)